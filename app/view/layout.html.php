...
<body>
    <div class="title-bar">
        <div class="row">
            <div class="title-bar-left">
                <span class="title-bar-title"><?php echo $site_info['site_title']; ?></span>
            </div>
    ...
    <footer>
        <div class='row'>
            <p>© 1998‐2016 ZURB, Inc. All rights reserved. <a href="/dashboard">Dashboard</a></p>
        </div>
    </footer>
